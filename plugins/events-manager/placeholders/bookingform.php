...
?>
<div id="em-booking" class="em-booking table <?php if( get_option('dbem_css_rsvp') ) echo 'css-booking'; ?>">
	<?php 
				...
				<?php if( $can_book ): ?>
					<div class='em-booking-form-details'>
						...
						<div class="em-booking-buttons">
							...
							<input type="image" src="<?php echo get_option('dbem_bookings_submit_button'); ?>" class="em-booking-submit button white" id="em-booking-submit" />
							<?php else: //Display normal submit button ?>
							<input type="submit" class="<?php if(is_admin()) echo 'button-primary '; ?>em-booking-submit btn btn-primary white" id="em-booking-submit" value="<?php echo esc_attr(get_option('dbem_bookings_submit_button')); ?>" />
							<?php endif; ?>
						</div>
