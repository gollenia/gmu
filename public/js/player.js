    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="34" height="34" data-play="playable" class="not-started playable">',
                '<g class="shape">',
                '<circle class="progress-track" cx="50" cy="50" r="40" stroke="#303540" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="2"/>',
                '<circle class="precache-bar" cx="50" cy="50" r="40" stroke="#303540" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="2" transform="rotate(-90 50 50)"/>',
                '<circle class="progress-bar" cx="50" cy="50" r="40" stroke="#0063dd" stroke-opacity="1" stroke-linecap="round" fill="none" stroke-width="2" transform="rotate(-90 50 50)"/>',
                '</g>',
                '<circle class="controls" cx="50" cy="50" r="45" stroke="none" fill="#000000" opacity="0.0" pointer-events="all"/>',
                '<g class="control pause">',
                '<line x1="43" y1="35" x2="43" y2="65" stroke="#303540" fill="none" stroke-width="8"/>',
                '<line x1="58" y1="35" x2="58" y2="65" stroke="#303540" fill="none" stroke-width="8"/>',
                '</g>',
                '<g class="control play">',
                '<polygon points="45,35 65,50 45,65" fill="#303540" stroke-width="0"></polygon>',
                '</g>',
                '<g class="control stop">',
                '<rect x="35" y="35" width="30" height="30" stroke="#00D47D" fill="none" stroke-width="1"/>',
                '</g>',
                '</svg>'];
